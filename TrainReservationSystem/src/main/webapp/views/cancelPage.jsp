...
<html>
	...
	<body class="px-5">
		<c:forEach items="${ myBookings }" var="booking">
			<div class="border bg-light rounded m-3 p-3 px-5 shadow">
				<div class="d-inline-block" style="width:100px;height:100px;position:relative;top:-40px">
				...
				<div class="float-left d-inline-block m-3" style="width:70%">
					...
					<div class="d-flex justify-content-between">
						...
						<div>
							<a href="cancel?pnr=${ booking.bookingId }" class="btn btn-danger px-4">Cancel</a>
						</div>
